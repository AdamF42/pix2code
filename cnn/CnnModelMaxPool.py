...
class CnnModelMaxPool(tf.keras.Model):

    def get_config(self):
        pass

    def __init__(self, image_count_words, kernel_shape=7, dense_layer_size=512, activation='relu', dropout_ratio=0.25,
    ...
    def compile(self, loss='mse', optimizer=tf.keras.optimizers.RMSprop(lr=0.0001, clipvalue=1.0), *args, **kwargs):
        if self.image_out:
